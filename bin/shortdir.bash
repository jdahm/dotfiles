#!/bin/bash
# Source: http://stackoverflow.com/questions/1616678/bash-pwd-shortening
#
# Authors:
#   @Eval_Krall 20091024: created script
#   @bobpaul 20100601: check if in $HOME and use ~ instead of absolute path
#
